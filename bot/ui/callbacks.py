...
class SubCheck(CallbackData, prefix="v"):
    """«✅ Проверить подписку» под подсказкой в группе. u — кому подсказка: только его нажатие проверяет
    подписку, админам кнопка показывает его статус, остальным — что она не для них."""
